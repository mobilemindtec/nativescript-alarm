...
public class BootstrapAlarmReceiver extends BroadcastReceiver{
  ...
  public void onReceive(Context context, Intent intent){
    ...
    Log.d("BootstrapAlarmReceiver", "##########################");
    Log.d("BootstrapAlarmReceiver", "###### BootstrapAlarmReceiver");
    Log.d("BootstrapAlarmReceiver", "##########################");
        ...
        if(datetimeStr != null){
          ...
          try{
            ...
            if(datetime.compareTo(today) > 0){
              ...
              Log.d("BootstrapAlarmReceiver", "## create alarm");
              ...
              Log.d("BootstrapAlarmReceiver", "## show notification");
            }
          }catch(Exception e){
            Log.i("BootstrapAlarmReceiver", "Erro processando BootstrapAlarmReceiver", e);
          }
